# =============================================================================
# LumTrails Infrastructure - Outputs (PRODUCTION)
# =============================================================================
...
output "mailing_service_url" {
  description = "URL of the Mailing Service"
  value       = var.create_cloud_run_services ? google_cloud_run_v2_service.mailing_service[0].uri : null
}
...
output "secret_ids" {
  ...
  value = {
    ...
    brevo_api_key               = google_secret_manager_secret.brevo_api_key.secret_id
  }
}
...
output "production_domain" {
  description = "The production domain"
  value       = local.production_domain
}

output "frontend_url" {
  description = "The production frontend URL"
