# =============================================================================
# LumTrails Infrastructure - Secret Manager (PRODUCTION)
# =============================================================================
# This file defines all secrets and IAM bindings for:
# - OpenAI API Key (PDF Scanner)
# - Firebase Storage Private Key
# - Stripe API Keys (Pricing Service) - PRODUCTION KEYS
# - GitHub OAuth Credentials (Integrations) - PRODUCTION APP
# - Notion OAuth Credentials (Integrations) - PRODUCTION APP
# - Brevo API Key (Mailing Service)
#
# ⚠️ IMPORTANT: BOM Character Prevention
# When adding secret values, ensure there are no BOM (Byte Order Mark)
# characters at the start of secret values. Use the provided
# migrate-secrets.ps1 script which strips BOM automatically.
# =============================================================================
...
# -----------------------------------------------------------------------------
# Stripe API Key (for Pricing Service) - PRODUCTION KEY
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# GitHub OAuth Client ID (for Integrations) - PRODUCTION APP
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Notion OAuth Client ID (for Integrations) - PRODUCTION APP
# -----------------------------------------------------------------------------
